            ...
            <div class="col-12 mb-3">
                <div class="card-box ">
                    <div class="m-t-0 m-b-30">
                        <h4 class="header-title d-inline-block ">ایجاد منو</h4>
                        <a href="/admin/grop"
                            class="btn btn-pink btn-trans waves-effect w-md waves-pink m-b-5 float-right">بازگشت</a>
                    </div>


                    <form class="form-horizontal form" method="post" action="/admin/menu/add" role="form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select required name="grop[]"
                                        id="grop_select2"
                                        onchange="grop_change(event)"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input parsley-trigger="change" required name="name" type="text"
                                            class="form-control" id="inputEmail31" placeholder="نام منو را وارد کنید">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="form" class="form-control select2">
                                            <option selected="" disabled="disabled">انتخاب فرم</option>
