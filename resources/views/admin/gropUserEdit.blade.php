            ...
            <div class="col-9 mb-3">
                <div class="card-box ">
                    <div class="m-t-0 m-b-30">
                        ...
                        <h4 class="header-title d-inline-block ">ویرایش گروه کاربری </h4>
                        <a href="/admin/grop/user/{{$grop["id"]}}"
                           class="btn btn-pink btn-trans waves-effect w-md waves-pink m-b-5 float-right">بازگشت</a>
                    </div>


                    <form class="form-horizontal form" method="post"  action="/admin/grop/user/edit/{{$usergrop["id"]}}" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
                       @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input parsley-trigger="change" required name="name" value="{{$usergrop["name"]}}" type="text" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea required name="text" type="text" class="form-control"
                                          id="inputEmail3" placeholder="توضیحات گروه کاربری را وارد کنید">{{$usergrop["text"]}}</textarea>
                            </div>
                        </div>
