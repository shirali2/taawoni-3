                ...
                <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                <a href="/admin/invoice/user/{{$invoice["id"]}}/{{$invoice_user["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="فرم های پرشده" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                <button class="btn btn-danger btn-delete" data-route='{{route("admin.invoiceUserPaysFinesDelete",[$invoice["id"],$invoice_user["id"]])}}' data-toggle="tooltip" data-placement="top" data-original-title="حذف"><i class="fa fa-times"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
