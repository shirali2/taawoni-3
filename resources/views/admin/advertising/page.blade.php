                ...
                <div id="datatable-buttons_wrapper" class="dataTables_wrapper  dt-bootstrap4 p-0 m-0 no-footer">
                    ...
                    <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting"  style="text-align: right !important;" >نام آکهی</th>
                                    ...
                                    <th class="sorting"  style="text-align: right !important;" aria-label="Salary: activate to sort column ascending">اقدامات /مشاهده</th>
                                </tr>
                                </thead>
                                ...
                                @foreach($advertising_pays as $advertising_pay)
                                       @if(isset($advertising_pay["id"],$advertising_pay["user"]["name"],$advertising_pay["user"]["name2"],$advertising_pay["user"]["mobile"] ))
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/admin/advertising/img/{{$advertising_pay["id"]}}"  class="btn btn-danger waves-effect">حذف بنر آگهی</a>
                                                </div>
                                                    @endif
                                            </div><!-- /.modal-content -->
                                        </div><!-- /.modal-dialog -->
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            ...
                                            @if(!$advertising_pay["active"]==1)
                                            <a href="/admin/advertising/active/{{$advertising_pay["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="تایید آگهی"  class="btn btn-success" ><i  class="fa fa-check"  ></i></a>
                                            @endif
                                            @if($advertising_pay["active_show"]==2)
                                            <button class="btn btn-danger btn-delete" id="{{$advertising_pay["id"]}}" name="{{$advertising_pay["product"]["name"]}}" data-toggle="tooltip" data-placement="top" data-original-title="حذف" ><i class="fa fa-times"></i></button>
                                             @endif
                                        </td>
                                    </tr>
                                    @endif
