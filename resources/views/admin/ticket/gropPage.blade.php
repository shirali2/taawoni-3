                    ...
                    <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                      <thead>
                        <tr role="row">
                            ...
                            <th class="sorting"  style="text-align: right !important;" >تعداد فعال</th>
                            <th class="sorting"  style="text-align: right !important;" >تعداد فعال های پشتیبانی فنی سامانه</th>
                        ...
                        <tbody>
                          @foreach($grops as $grop)
                            <tr role="row" class="odd">
                              ...
                              <td style="text-align: right !important;">{{$grop["count_tickets_enable"]}}</td>
                              <td style="text-align: right !important;">{{$grop["count_tickets_system_technical_support_enable"]}}</td>
                              <td style="display: none;" class="d-block-s">
                                <a href="/admin/ticket/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="نمایش تیکت ها" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                              </td>
                            </tr>
                          @endforeach
                        </tbody>
