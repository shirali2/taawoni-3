        ...
        <div class="row">
            <div class="col-12 mb-3">
                <div class="card-box ">
                    ...
                    <form class="form-horizontal form" method="post" action="/admin/grop/add"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input parsley-trigger="change" required name="name" type="text"
                                            class="form-control" id="inputEmail3" placeholder="نام  مجموعه را وارد کنید">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail31" class="col-sm-3 col-form-label">تاریخ اعتبار مجموعه</label>
                                    <div class="col-sm-8">
                                        <input parsley-trigger="change" required name="am" id="test-date-id"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input parsley-trigger="change" required name="top" type="text"
                                            class="form-control" id="inputEmail31" placeholder="عناوین بالا را وارد کنید">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail31" class="col-sm-3 col-form-label">عناوین پایین</label>
                                    <div class="col-sm-8">
                                        <input parsley-trigger="change" required name="bottom" type="text"
                                            class="form-control" id="inputEmail31" placeholder="عناوین پایین را وارد کنید">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class=" mb-3  col-lg-6 col-xl-4">
                                    ...
                                    <label for="Bills">
                                        ...
                                        <input id="Bills" value="1" name="user_menu_access[0][hide]"
