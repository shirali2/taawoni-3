        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    <a href="/admin/grop/user/add/{{$grop["id"]}}" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن گروه کاربری جدید</a>
                </div>
                                ...
                                @foreach($usergrops as $usergrop)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            ...
                                            <a href="/admin/grop/user/edit/{{$usergrop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
