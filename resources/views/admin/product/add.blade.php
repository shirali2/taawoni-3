      ...
      <div class="col-12 mb-3">
        <div class="card-box ">
          <div class="m-t-0 m-b-30">
            <h4 class="header-title d-inline-block">ایجاد اشتراک</h4>
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input parsley-trigger="change" required name="name" type="text" class="form-control" id="name" placeholder="ضروری" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input parsley-trigger="change" required name="number-days" type="text" class="form-control" id="number-days" placeholder="ضروری" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input parsley-trigger="change"  name="amount-1-day" data-parsley-type="number" type="text" class="form-control" id="amount-1-day" placeholder="ضروری" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <p id="total-amount" class="border mb-0 p-2 text-justify text-break">سیستمی</p>
                  </div>
                </div>
                  ...
                  <div class="col-sm-8">
                    <select name="status" class="form-control select2" required>
                      @foreach($statuses as $key_status => $name_status)
                        <option value="{{$key_status}}">{{$name_status}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
  ...
  <script type="text/javascript" language="JavaScript">
    ...
    var amount_1_day = jQuery('#amount-1-day'), //مبلغ 1 روز
        ...
        total_amount = jQuery('#total-amount'); //مبلغ کل
          text_default_total_amount = total_amount.text(); //متن پیشفرض مبلغ کل
    ...
    jQuery('#package-type').change(function(){
      if(jQuery(this).val() == 3){ //تشویقی
        amount_1_day.val('').attr('disabled', 'disabled');
        total_amount.addClass('form-control').attr('readonly', '').text('در نوع بسته تشویقی مبلغ غیرفعال است')
      }else{
        amount_1_day.val(value_amount_1_day).removeAttr('disabled').change();
