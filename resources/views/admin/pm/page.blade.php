      ...
      <div class="col-12 mb-3">
          <div  class="card-box table-responsive">
              <div class="m-t-0 m-b-30">
                  ...
                  <a href="/admin/pm/add" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن پیام</a>
                  ...
                  <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                              ...
                              @foreach($pms as $pm)
                                  ...
                                  <tr role="row" class="odd">
                                      ...
                                      <td style="text-align: right !important;">{{ $pm->groups->pluck('name')->implode(', ') }}</td>
                                      ...
                                      <td style="display: none;" class="d-block-s">
                                        <a href="/admin/pm/show/{{$pm["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title=" مشاهده شده" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                        <a href="/admin/pm/dontshow/{{$pm["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title=" مشاهده نشده" class="btn btn-success"><i class="fa fa-eye"></i></a>

                                        <a href="/admin/pm/edit/{{$pm['id']}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-success mt-2 mb-2"><i class="fa fa-edit"></i></a>
