...
@section("container")
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select id="inputEmail34" required name="grop[]" multiple class="form-control select2" data-placeholder="انتخاب مجموعه (چند انتخابه)">
  ...
  <script type="text/javascript" language="JavaScript">
    ...
    var ajax_get_users_grop; //ایجکس دریافت کاربران مربوط به مجموعه
    $('select[name="gropUser[]"]').change(function(){
      ...
      if(grop_user_selected.length == 0){
          return ;
      ...
      ajax_get_users_grop = $.ajax('/admin/pm/add/user', {
        type: 'post',
        async: false,
        data: {
          _token: token,
