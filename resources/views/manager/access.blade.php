...
@section("container")
    @php
        $accessItems = $accessItems ?? ($setting ? (json_decode($setting["input3"], true) ?: []) : []);
    @endphp
    <!-- DataTables -->
        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    {{--<a href="/manager/grop" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن مدیر جدید</a>--}}
                </div>
                                    ...
                                    @foreach($accessItems as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="display: none;" class="d-block-s">
                                                ...
                                                <a href="/manager/grop/access/page/{{$grop["id"]}}/{{$item["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="نمایش"  class="btn btn-success"><i class="fa fa-eye"></i></a>                                        </td>
                                ...
                                <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                                    ...
                                    @foreach($usergrops as $item2)
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="display: none;" class="d-block-s">
                                                {{--<a href="/manager/grop/manager/edit/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-warning"><i class="fa fa-pencil"></i></a>--}}
                                                <a href="/manager/grop/access/accessGropUser/{{$item2["id_grop"]}}/{{$item2["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="نمایش"  class="btn btn-success"><i class="fa fa-eye"></i></a>                                        </td>
                                        </tr>
