      ...
      <div class="row">
          <div class="col-12 mb-3">
              <div class="card-box ">
                  ...
                  <form class="form-horizontal form" method="post" action="/manager/menu/add" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input parsley-trigger="change" required name="name" type="text" class="form-control" id="inputEmail31" placeholder="نام منو را وارد کنید">
                        </div>
                      </div>
                          <div class="form-group row">
