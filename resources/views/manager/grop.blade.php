        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    @if(\App\Http\Controllers\managerController::managerAccessLevel(53))
                    <a href="/manager/grop/add" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن مجموعه</a>
                    @endif
                </div>
                @if(session('success'))
                                ...
                                @foreach($grops as $grop)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            @if(\App\Http\Controllers\managerController::managerAccessLevel(62) or \App\Http\Controllers\managerController::managerAccessLevel(63))
                                               @if(\App\Http\Controllers\managerController::managerAccessLevel(63) and !\App\Http\Controllers\managerController::managerAccessLevel(62))
                                                    <a href="/manager/grop/manager/add/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="افزودن مدیر" class="btn btn-success"><i class="fa fa fa-user-o"></i></a>
                                                @else
                                                    <a href="/manager/grop/manager/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="افزودن مدیر" class="btn btn-success"><i class="fa fa fa-user-o"></i></a>
                                                @endif
                                            @endif
                                            @if(\App\Http\Controllers\managerController::managerAccessLevel(59) or \App\Http\Controllers\managerController::managerAccessLevel(60) or \App\Http\Controllers\managerController::managerAccessLevel(61))
                                           <a href="/manager/grop/user/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="افزودن گروه کاربری" class="btn btn-custom"><i class="fa fa-vcard-o "></i></a>
                                             @endif
                                            @if(\App\Http\Controllers\managerController::managerAccessLevel(57))
                                            <a href="/manager/grop/edit/code/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="تغییر کد عضوگیری" class="btn btn-warning"><i class="fa fa fa-hashtag"></i></a>
                                         @endif
                                           @if(\App\Http\Controllers\managerController::managerAccessLevel(56))
                                            <a href="/manager/grop/edit/{{$grop["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                            @endif
                                            @if(\App\Http\Controllers\managerController::managerAccessLevel(58))
