        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    <h4 class="header-title d-inline-block ">فهرست مدیران سطح دسترسی {{$setting["name"]}} در مجوعه {{$grop["name"]}}</h4>
                                ...
                                @foreach($managerAccess as $item)
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            ...
                                            <button class="btn btn-danger btn-delete" idGropUser="{{$setting["id"]}}" id="{{$item["id"]}}" name="{{$item["user"]["name"]}}" data-toggle="tooltip" data-placement="top" data-original-title="حذف" ><i class="fa fa-times"></i></button>
                                        </td>
