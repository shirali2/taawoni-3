        ...
        <div class="row justify-content-center">
            <div class="col-9 mb-3">
                <div class="card-box ">
                    ...
                    <form class="form-horizontal form" method="post"  action="/manager/grop/user/edit/{{$usergrop["id"]}}" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
                       @csrf
