        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    <a href="/manager/product/add" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن محصول</a>
                </div>
                <div id="datatable-buttons_wrapper" class="dataTables_wrapper  dt-bootstrap4 p-0 m-0 no-footer">
                    ...
                    <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting"  style="text-align: right !important;" >ماه</th>
                                ...
                                @foreach($products as $product)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="text-align: right !important;">{{$product["am"]}}</td>
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            <a href="/manager/product/edit/{{$product["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                            <a href="/manager/product/active/{{$product["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="تغییر وضعیت" @if($product["active"]==1) class="btn btn-danger" @else class="btn btn-success" @endif><i @if($product["active"]==1) class="fa fa-lock" @else class="fa fa-unlock" @endif ></i></a>

                                            {{--<a href="/manager/form/user/{{$form["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="فرم های پرشده" class="btn btn-success"><i class="fa fa-eye"></i></a>--}}
