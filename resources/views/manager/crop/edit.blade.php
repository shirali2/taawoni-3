                        ...
                        <div class="col-12">
                            ...
                            <div class=" mb-4">
                                <div class="col-8" style="margin: 0 auto;">
                                    ...
                                    <input name="img" id="inputimg"  type="file" class="dropify" data-default-file="/crop_img/{{$product["img"]}}"  />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <textarea parsley-trigger="change" required  name="text" type="text" class="form-control"
                                          id="inputEmail31" placeholder="توضیح محصول را وارد کنید">{{$product["text"]}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input parsley-trigger="change" required name="price" value="{{$product["price"]}}" type="text" class="form-control"
