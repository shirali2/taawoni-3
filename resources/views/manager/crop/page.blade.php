        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    @if(\App\Http\Controllers\managerController::managerAccessLevel(34))
                    <a href="/manager/crop/add" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن محصول</a>
              @endif
                </div>
                                ...
                                @foreach($products as $product)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            <a href="/manager/crop/pay/{{$product["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="لیست خریداران" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                            @if(\App\Http\Controllers\managerController::managerAccessLevel(34))
                                                <a href="/manager/crop/edit/{{$product["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                         @endif
                                            @if(\App\Http\Controllers\managerController::managerAccessLevel(35))
                                                <a href="/manager/crop/active/{{$product["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="تغییر وضعیت" @if($product["active"]==1) class="btn btn-danger" @else class="btn btn-success" @endif><i @if($product["active"]==1) class="fa fa-lock" @else class="fa fa-unlock" @endif ></i></a>
                                                @endif
