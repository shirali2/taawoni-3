        ...
        <div class="col-12 col-lg-8 mb-3">
            <div class="card-box ">
                <div class="m-t-0 m-b-30">
                    ...
                    <a href="/manager/user" class="btn btn-pink btn-trans waves-effect w-md waves-pink m-b-5 float-right">بازگشت</a>
                    <a href="/ExcelSamples/ImportUsersByExelTemplate.xlsx" class="btn btn-default btn-trans w-md m-b-5 float-right">دانلود قالب</a>
                </div>
