...
@section("container")
@php
$access_manager = ($manager && $manager['access'] && $manager['access'] !== 'null') ? (json_decode($manager['access'], true) ?: []) : []; //دسترسی ها
$accessItems = $setting ? (json_decode($setting["input3"], true) ?: []) : [];
  ...
  if(in_array(63, $access_manager)) $access_manager = array_merge($access_manager, array(6.5, 11.5));
@endphp
      ...
      <div class="row justify-content-center">
          <div class="col-9 mb-3">
              <div class="card-box ">
                  ...
                  <form class="form-horizontal form" method="post"  action="/manager/grop/manager/add/{{$grop["id"]}}" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
                     @csrf
