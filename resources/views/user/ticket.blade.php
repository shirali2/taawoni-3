      ...
      <div class="col-12 mb-3">
          <div  class="card-box table-responsive">
              <div class="m-t-0 m-b-30">
                  ...
                  <h4 class="header-title d-inline-block ">فهرست تیکت ها- گفتگوها </h4>
                  <a href="/user/ticket/add/" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن تیکت</a>
              </div>
              <div id="datatable-buttons_wrapper" class="dataTables_wrapper  dt-bootstrap4 p-0 m-0 no-footer">
                  ...
                  <table id="datatable-buttons" class="table demo datatable-buttons table-striped table-bordered p-0 m-0 dataTable no-footer" role="grid" aria-describedby="datatable-buttons_info" style="width: 100%;direction: rtl;" width="100%" cellspacing="0">
                              ...
                              <tr role="row">
                                  ...
                                  <th class="sorting"  style="text-align: right !important;" aria-label="Salary: activate to sort column ascending">مشاهده </th></tr>
                              </thead>
                              ...
                              @foreach($tickets as $ticket)
                                  ...
                                  <tr role="row" class="odd">
                                      ...
                                      <td style="display: none;" class="d-block-s">
                                        <a href="/user/ticket/message/{{$ticket["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="نمایش" class="btn btn-primary"><i class="fa fa-eye"></i></a>

                                        @if($ticket["new"]==1)
                                          <span class="badge badge-success">پیام جدید</span>
                                        @endif
